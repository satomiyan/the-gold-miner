 ...
 */
public class Bg {
    public static int level = 1;// Current level of the game
    public static int goal = level * 5;// Goal points to reach next level
    public static int count = 0;// Current points earned in the game
    public static int waterNum = 3;// Number of water resources available
    public static boolean waterFlag = false;// Flag indicating if water is available
    public long startTime;
    private long endTime;

    private int price = 5;// Price of water resource
    private boolean shop = false;// Flag indicating if the player is in the shop
    private Image land = Toolkit.getDefaultToolkit().getImage("images/land.jpg");
    private Image sky = Toolkit.getDefaultToolkit().getImage("images/sky.jpg");
    private Image worker = Toolkit.getDefaultToolkit().getImage("images/worker.png");
    private Image water = Toolkit.getDefaultToolkit().getImage("images/water.png");
